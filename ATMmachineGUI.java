...
public class ATMmachineGUI {
    ...
    private static void showMenu() {
        ...
        depositBtn.addActionListener(e -> {
            ...
            String input = JOptionPane.showInputDialog(menuFrame, "Enter amount to deposit balance:");
            if (input != null) {
                try {
        ...
        withdrawBtn.addActionListener(e -> {
            String input = JOptionPane.showInputDialog(menuFrame, "Enter amount  to withdraw balance :");
            if (input != null) {
                try {
                    double amount = Double.parseDouble(input);
